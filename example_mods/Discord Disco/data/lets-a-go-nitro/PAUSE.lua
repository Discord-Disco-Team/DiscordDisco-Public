...
local songEnd = 90
local splashText = {'wawawawawawawa', ':3333', 'who likes men', 'discord disco', 'OUGH I NEED COCKKKK', 'apple bottom jeans', 'im freaky rn fella', 'this is just splash text', 'follow me on twt its @fizzyflux', 'Letsing my go', 'dont follow Fizzy follow me instead at @NinaNorthenFNF', 'FUCK IM GREEN', 'Im gonna kill myself', 'Have you tried pressing 7?', '',};
