...
local songEnd = 90
local splashText = {'wawawawawawawa', ':3333', 'freeplay splash text', 'discord disco', 'ough im so fat', 'twinkletoes over here, bruh', 'im gonna crash out', 'this is just splash text', 'follow me on twt its @anilmky_nikko', 'Im not gonna instigate with this one just follow Abicus please', 'redpilled', 'We can edge in costco?', '',};
