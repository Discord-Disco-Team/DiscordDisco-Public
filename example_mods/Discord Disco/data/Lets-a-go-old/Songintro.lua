    ...
    IntroSubText2Size = 19
    IntroTagColor = '79ff94' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Lets-A Go', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'By Bl!ndsxnse & Fizzysoda', 300, -305-IntroTagWidth, 260)
