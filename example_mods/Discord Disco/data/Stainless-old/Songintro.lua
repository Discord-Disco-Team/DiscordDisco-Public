    ...
    IntroTagColor = 'a1a0b7' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Stainless', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'By Bl!ndsxnse & Uhhh..', 300, -305-IntroTagWidth, 260)
