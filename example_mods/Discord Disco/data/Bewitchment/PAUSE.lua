...
local songEnd = 90
local splashText = {'wawawawawawawa', ':3333', 'I like men', 'discord disco', 'OUGH I NEED PUSSYYYYYY', 'boots with the fur', 'Megaz morez like.. Goat', 'this is just splash text', 'follow me on twt its @devilishfox82', 'This guy is a massive queer', 'dont follow Devilish follow me instead at @MrMisty11', 'Im blue, if i was green i would die', 'My balls are blue', 'Have you tried pressing 7?', '',};
