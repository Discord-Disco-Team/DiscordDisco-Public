...
local songEnd = 90
local splashText = {'wawawawawawawa', ':3333', 'Capybara', 'discord disco', 'Rats make me crazy', 'I was locked in a room', 'A room with rats', 'this is just splash text', 'follow me on twt its @FurretTopHat', 'Guys i like tickling toes!', 'dont follow Furret follow me instead at @Xx_Lu1g1f4n_xX', 'IM TWEAKIN OUT', 'Tweakers paradise', 'Have you tried pressing 7?', '',};
